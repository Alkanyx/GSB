...
<div name="droite" style="float: left; width: 80%;">
	<div name="bas"
		style="margin: 10 2 2 2; clear: left; background-color: black; color: white; height: 88%;">
		<form name="formRAPPORT_VISITE" method="post"
			action="recupRAPPORT_VISITE.php">
			...
			<label class="titre">SAISIE DEFINITIVE :</label><input
				name="RAP_LOCK" type="checkbox" class="zone" checked="false" /> <label
				class="titre"></label>
			<div class="zone">
