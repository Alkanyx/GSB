...
function calendrier(year, month, day) {
    ...
    calendrierSortie = "<p class=\"titleMonth\" style=\"position:relative;z-index:200;\"> <a href=\"javascript:alimenterChamps('')\" style=\"float:left;margin-left:3px;color:#cccccc;font-size:10px;z-index:200;font-style:italic\"> Effacer la date </a><a href=\"javascript:masquerCalendrier()\" style=\"width: 20px;height: 20px;border-radius: 10px;margin: 3px 3px 0px 0px;background-color: white;z-index: 200;color: red;float: right;\">X</a>&nbsp;</p>";
